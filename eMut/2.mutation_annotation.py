...
def mutation_annotation(item):
    item = item.rstrip('\n')
    #筛选vcf文件
    os.system("/cluster2/huanglab/jzhu/app/bcftools-1.10/bcftools filter -i \'FILTER==\"PASS\"\' \
    ...
    os.system("perl /cluster2/huanglab/jzhu/app/vcf2maf-1.6.21/vcf2maf.pl --input-vcf {vepDir}/{cell}.vep.vcf \
